  ...
  <div class="container-fluid">
    ...
    <div class="row heading-bg  bg-green">
      <div class="col-lg-3 col-md-5 col-sm-4 col-xs-12">
        <h5 class="txt-light">Subscription Payment Confirmation</h5>
      </div>
      <!-- Breadcrumb -->
      <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
        <ol class="breadcrumb">
          <li><a href="{{ route('member') }}">Dashboard</a></li>
          <li><a href="#"><span>Subscription Payment Confirmation</span></a></li>
        </ol>
      </div>
      <!-- /Breadcrumb -->
    </div>
        ...
        <div class="panel panel-default card-view">
          ...
          <div class="panel-wrapper collapse in">
            <div class="panel-body">
              <div id="payment-form">
                <form method="POST" action="{{ route('subscribe_now_new') }}">
                  @csrf
                  <div class="row">
                    <div class="col-sm-12">
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      <div class="form-group">
                        ...
                        <input type="file" class="form-control" name="prove" value="{{ old('prove') }}">
                      </div>
                    </div>
                  </div>
