	...
	<ul class="nav navbar-right top-nav pull-right">
		<li class="dropdown">
			...
			<ul class="dropdown-menu user-auth-dropdown" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
				<li>
					<a href="{{ route('admin_profile') }}"><i class="fa fa-fw fa-user"></i> Profile</a>
				</li>
				<li>
					<a href="{{ route('admin_subscription') }}"><i class="fa fa-fw fa-credit-card-alt"></i> Subscriptions</a>
				</li>
				<li>
				...
				<li>
					<a href="{{ route('admin_inactive_member') }}"><i class="fa fa-fw fa-users"></i> Inactive Members</a>
				</li>
				<li class="divider"></li>
				<li>
