								...
								<tr>
									...
									<td class="">
										...
										<div class="btn-group" role="group" aria-label="Basic example">
											<a href="{{ url('admin/view-department', $department->id) }}" class="btn btn-success m-1"><i class="la la-eye" data-toggle="tooltip" data-placement="top" title="View"></i></a>
											...
											<a href="{{ url('admin/delete-department', $department->id) }}" class="btn btn-danger m-1" onclick="return confirm('Are you sure you want to delete Department of {{$department->name}}?')"><i class="la la-trash" data-toggle="tooltip" data-placement="top" title="Delete"></i></a>
										</div>
									</td>
								</tr>
								@endforeach
