	...
	<div class="col-lg-12">
		<div class="billing-form-item">
			<div class="billing-title-wrap">
				<div class="row">
					<div class="col-10">
						<h3 class="widget-title pb-0">All Departments in {{$faculty->name}} ({{$faculty->code}})</h3>
