	...
	<div class="ttr-sidebar-wrapper content-scroll">
		...
		<nav class="ttr-sidebar-navi">
			<ul>
				...
				<li>
					<a href="{{ route('log-book') }}" class="ttr-material-button">
						<span class="ttr-icon"><i class="ti-book"></i></span>
						<span class="ttr-label">Log-Book</span>
					</a>
				</li>
				<li>
				...
				<li>
					<a href="{{ route('logout') }}" class="ttr-material-button" onclick="event.preventDefault();
