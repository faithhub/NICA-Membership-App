...
<head>
	...
	<!-- PAGE TITLE HERE ============================================= -->
	<title>Supervisor Dashboard - {{$title ?? ''}} </title>
	...
	@include('supervisor.layouts.includes.style')
	@include('supervisor.layouts.includes.alert')
...
<body class="ttr-opened-sidebar ttr-pinned-sidebar">
	...
	<!-- header start -->
	@include('supervisor.layouts.includes.header')
	<!-- header end -->
	<!-- Left sidebar menu start -->
	@include('supervisor.layouts.includes.sidemenu')
	...
	@include('supervisor.layouts.includes.script')
</body>
